...
import { inc, dec, reset, asyncInc} from './store/actions';
...
export default function Counter() {
  ...
  const disableState = useSelector(state => state.buttons)

  return (
    <Container>
        <div style={{paddingTop: '100px'}}>
            
          <h1 style={{fontSize:'150px'}} className={styles.number}>{count}</h1>
       
          <div className={styles.wrapper}>
            <button disabled={disableState.disabled} onClick={() => dispatch(inc)} className={styles.cardGreen}>
            ...
            <button disabled={disableState.disabled} onClick={() => dispatch(dec)} className={styles.cardYellow}>
